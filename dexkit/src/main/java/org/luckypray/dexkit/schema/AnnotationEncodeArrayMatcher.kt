...
internal class `-AnnotationEncodeArrayMatcher` : Table() {
    ...
    fun values(j: Int) : `-AnnotationEncodeValueMatcherUnion`? = values(`-AnnotationEncodeValueMatcherUnion`(), j)
    fun values(obj: `-AnnotationEncodeValueMatcherUnion`, j: Int) : `-AnnotationEncodeValueMatcherUnion`? {
        val o = __offset(4)
        return if (o != 0) {
